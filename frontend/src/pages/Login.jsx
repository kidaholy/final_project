...
const Login = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('/wolkite-uni.png')" }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center space-y-6 px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-10">
          <div className="flex flex-col items-center md:items-start space-y-6 text-center md:text-left">
            <p className="text-white text-3xl md:text-5xl font-extrabold leading-tight drop-shadow-lg">Wolkite University<br />Human Resource Management System</p>
